...
https://kaitlynould-eng.github.io/bike-rear-traffic-detector/
...
<div align="center">
    <img src="paula_with_bike.png" width="600">
    <br>
    <b>Figure 1:</b> User with RadPower E-trike.
</div>
...
<div align="center">
    ...
    <br>
    <b>Figure 3:</b> Enclosure design.
</div>
<div align="center">
    <img src="motormountCAD.png" width="600">
    <br>
    <b>Figure 4:</b> Motor mount design.
</div>
...
<div align="center">
    <img src="battery.png" width="600">
    <br>
    <b>Figure 5:</b> 2S Li-ion Battery.
</div>
...
<div align="center">
    <img src="radar.png" width="600">
    <br>
    <b>Figure 7:</b> Radar module mounted to enclosure for testing.
</div>
...
<div align="center">
    ...
    <br>
    <b>Figure 8:</b> Motors mounted in 3D printed attachment.
</div>
...
<div align="center">
    ...
    <br>
    <b>Figure 10:</b> IWR6843AOP Evaluation Module switch locations used during development.
</div>
...
## Drivers
All drivers developed for this project can be found within the Core folder of the repository. This section provides an overview of the custom drivers and application code created to support the bicycle safety system. Four primary modules were developed and modified throughout the project: the Radar, Haptic, IMU, and Main modules. Together, these files form the foundation of the embedded software architecture and enable communication between the hardware components while implementing the system's overall functionality. The following subsections describe the purpose, implementation, and key features of each module.
